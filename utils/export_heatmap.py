...
def generate_heatmaps(net, raw_dataset, args, config):
    ...
    if args.problem == 'vrp':
        ...
        reader = DataReader(num_nodes, num_neighbors, batch_size, instance_filepath, do_prep=not do_prepwrap, raw_dataset=raw_dataset)
...
if __name__ == "__main__":
    ...
    generate_heatmaps(None, None, args)
